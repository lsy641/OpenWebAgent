...
dual_agent = DualAgent(client=openai_client, model=model, act_book=act_book, web_manager="selenium", test_id_attribute=TEST_ID_ATTRIBUTE, log_dir="./logs/demo", hard_coded_goal=hard_coded_goal, verbose=True)
